...
def run():
    ...
    # Função para carregar o arquivo Excel e exibir colunas
    def load_excel(file):
    ...
    if db_url:
        ...
        if file:
            ...
            if st.button("Adicionar Mapeamento"):
                mappings.append({"excel_field": None, "db_table": None, "db_column": None})
            ...
            for i, mapping in enumerate(mappings):
                ...
                with col3:
                    if table_db:
                        ...
                        mappings[i] = {"excel_field": excel_field, "db_table": table_db, "db_column": db_column}
